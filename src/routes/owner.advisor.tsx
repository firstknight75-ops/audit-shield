...
import {
  Sparkles, ShieldAlert, FileText, CheckCircle2, AlertOctagon, UserCheck,
  Building2, ArrowLeft, Send, Check, RefreshCw, MessageSquare, Clock, HelpCircle, AlertTriangle
} from "lucide-react";
...
const COPY = {
  ar: {
    ...
    subtitle: "تفسير ذكي للتقارير المعقدة إلى قرارات مباشرة، ومراقبة أداء المدققين والتحقق من أمان أرقامك.",
    selectCompany: "اختر الشركة للمتابعة الفورية",
    noTechnicalBackgroundNeeded: "هذا القسم مصمم خصيصاً لأصحاب القرار. لا تحتاج لأي خلفية محاسبية أو تقنية.",
  ...
  ckb: {
    ...
    subtitle: "وەرگێڕانی ژیرانەی ڕاپۆرتە ئاڵۆزەکان بۆ بڕیاری ڕاستەوخۆ، و چاودێریکردنی کارایی پشکنەران.",
    selectCompany: "کۆمپانیا هەڵبژێرە بۆ بەدواداچوونی خێرا",
    noTechnicalBackgroundNeeded: "ئەم بەشە تایبەتە بە خاوەن بڕیارەکان. پێویستت بە هیچ پاشبنەمایەکی ژمێریاری نییە.",
...
const ADV_COMPANIES_DATA: Record<string, CompanyAdvisorProfile> = {
  "c1": {
    ...
    auditorMetrics: {
      ...
      demerits: 1,
      violationsList: [
        { ar: "تجاوز تنبيه تكرار الفاتورة INV-2026-0481 واعتمادها كفاتورة فريدة بالخطأ قبل مراجعة المستند المرفق.", ckb: "تێپەڕاندنی ئاگادارکردنەوەی دووبارەبوونی فاتورەی INV-2026-0481 و قبوڵکردنی بە هەڵە پێش پێداچوونەوە.", type: "critical" }
      ],
      verifiedLedgerEntriesCount: 384
    },
    keyIssues: [
      {
        title: { ar: "فاتورة شراء مكررة مع شركة الرافدين", ckb: "فاتورەی کڕینی دووبارە لەگەڵ کۆمپانیای الرافدین" },
      ...
      {
        title: { ar: "تفاوت بين المشتريات والمخزن بالفروع", ckb: "جیاوازی کڕین و کۆگا لە لقەکاندا" },
  ...
  "c2": {
    ...
    auditorMetrics: {
      ...
      demerits: 4,
      violationsList: [
        { ar: "تعديل يدوي متكرر لأسعار الشراء بعد اعتمادها وتجاوز تنبيهات الفروقات السعرية الكبيرة.", ckb: "دەستکاریکردنی دەستی بەردەوام بۆ نرخەکانی کڕین دوای پەسەندکردنیان و تێپەڕاندنی فوارقی نرخەکان.", type: "critical" },
        { ar: "تأخر في مطابقة كشف حساب مصرف الجنوب الإسلامي لمدة تجاوزت 48 ساعة عن الـ SLA.", ckb: "دواکەوتنی هاوتاکردنی کای بانک بۆ زیاتر لە ٤٨ کاتژمێر.", type: "warning" }
      ],
      verifiedLedgerEntriesCount: 192
    },
    keyIssues: [
      {
        title: { ar: "تعديل أسعار شراء السكر والقمح بعد الاعتماد", ckb: "گۆڕینی نرخی کڕینی شەکر و گەنم دوای پەسەندکردن" },
  ...
  "c3": {
    ...
    keyIssues: [
      {
        title: { ar: "تأخر مستمر في فواتير غاز الطهي الأسبوعية", ckb: "دواکەوتنی فاتورەی گازی چێشت لێنان" },
...
const TRANSLATOR_LIBRARY = [
  {
    ...
    implicationAr: "حتى المدقق المحاسبي لا يستطيع رؤية أرباحك الصافية أو خريطة الهدر الحساسة في قاعدة البيانات إلا بإذنك المكتوب. أسرار شركتك محمية تقنياً وليس فقط في الواجهات.",
    implicationCkb: "تەنانەت پشکنەریش ناتوانێت قازانجی کۆتایی یان نەخشەی بەفیڕۆچوونی تۆ ببینێت لە داتابەیسدا تەنها بە مۆڵەتی نووسراوی تۆ نەبێت.",
    actionAr: "اطمئن، هذا يضمن ألا يقوم محاسب أو مدقق بنقل بيانات منافسيك أو كشف خططك الاستثمارية.",
    actionCkb: "خاڵە، دڵنیابە ئەمە ڕێگری دەکات لەوەی پشکنەر داتاکانت ئاشکرا بکات یان بیبات بۆ ڕکابەرەکانت."
  },
  {
    term: "Demerit Sweep Overdue Overrides",
    titleAr: "عقوبات الإهمال وجرد المخالفات",
    titleCkb: "سزای کەمتەرخەمی پشکنەران",
    descAr: "النظام يقوم بمراقبة وقت استجابة مدقق الحسابات لتصحيح الأخطاء وعقابه تلقائياً بنقاط جزاء.",
    descCkb: "سیستمەکە چاودێری کاتی کارکردنی پشکنەر دەکات و سزای دەدات بە خاڵی نەرێنی ئەگەر درەنگ وەڵام بداتەوە.",
    implicationAr: "إذا ترك المدقق تنبيهاً حرجاً (مثل الفاتورة المكررة) لأكثر من 4 ساعات دون حل، يخصم السيستم من كفاءته تلقائياً لمنع الكسل وتراكم العمل.",
    implicationCkb: "ئەگەر پشکنەر بۆ ماوەی زیاتر لە ٤ کاتژمێر ئاگادارکردنەوەیەکی گرنگ جێبهێڵێت، سیستمەکە خاڵی لێ دەبڕێت بۆ ڕێگریکردن لە تەمەڵی.",
    actionAr: "اسأل مدققك المحاسبي فوراً عندما تنخفض نسبة كفاءته عن 85% لكي يعرف أنك تراقبه بدقة رقمية.",
    actionCkb: "کاتێک کارایی پشکنەرەکەت دابەزی بۆ ژێر ٨٥٪ لێی بپرسەوە بۆ ئەوەی بزانێت کە بە وردی چاودێری دەکەیت."
  },
  {
    ...
    descAr: "المدقق وافق على أرقام فاتورة كانت جودتها منخفضة ومشكوك في دقة قراءتها آلياً دون مراجعتها يدوياً.",
    descCkb: "پشکنەرەکە ڕەزامەندی لەسەر ژمارەی فاتورەیەک داوە کە خوێندنەوەی ئامێری بۆی لاواز بووە بەبێ ئەوەی بە دەست پێداچوونەوەی بۆ بکات.",
    implicationAr: "هناك خطر كبير أن يكون مبلغ الفاتورة المعتمد خاطئاً (مثلاً: قراءة الـ 8 كـ 3)، مما يسبب تضخيم فواتير وهمية أو دفع مبالغ زائدة بالخطأ.",
    implicationCkb: "مەترسی هەیە بڕی فاتورە پەسەندکراوەکە هەڵە بێت (بۆ نموونە خوێندنەوەی ٨ وەک ٣)، ئەمەش دەبێتە هۆی دانی پارەی زیادە.",
    actionAr: "الزم المدقق بإرفاق صورة المستند الأصلي المصادق عليه يدوياً لأي فاتورة يقل تقييم الذكاء الاصطناعي لها عن 70%.",
    actionCkb: "پشکنەر ناچار بکە وێنەی بەڵگەنامە ئەسڵییەکە پێشکەش بکات بۆ هەر فاتورەیەک کە نرخاندنی زیرەکی دەستکردی کەمترە لە ٧٠٪."
  }
];
...
const PRESET_QUESTIONS = [
  ...
  },
  {
    ...
    answerAr: (profile: CompanyAdvisorProfile) => {
      if (profile.keyIssues.length === 0) return `في هذه الشركة، الهدر المالي منخفض جداً والسيستم لم يسجل أي تسريبات كاش حرجة حالياً. أرقامك ممتازة وسليمة!`;
      const issuesStr = profile.keyIssues.map(i => `- **${i.title.ar}** (القيمة التقريبية: ${formatIQD(i.impact)}) - ${i.risk.ar}`).join("\n");
    ...
    answerCkb: (profile: CompanyAdvisorProfile) => {
      if (profile.keyIssues.length === 0) return `لەو کۆمپانیایەدا خەساری دارایی زۆر کەمە و سیستمەکە هیچ لێچوونێکی گرنگی تۆمار نەکردووە.`;
      const issuesStr = profile.keyIssues.map(i => `- **${i.title.ckb}** (بڕی نزیکەیی: ${formatIQD(i.impact)})`).join("\n");
...
function OwnerAdvisorPage() {
  ...
  const handleAskPreset = (qAr: string, qCkb: string, answerFn: (profile: CompanyAdvisorProfile) => string) => {
  ...
  const handleCustomQuery = (e: React.FormEvent) => {
    ...
    if (locale === "ar") {
      if (query.includes("كاش") || query.includes("خسارة") || query.includes("هدر") || query.includes("فلوس")) {
      ...
      } else if (query.includes("أمان") || query.includes("تلاعب") || query.includes("سرقة") || query.includes("حماية")) {
      ...
      } else if (query.includes("المدقق") || query.includes("المحاسب") || query.includes("كفاءة") || query.includes("أداء")) {
      ...
      // Kurdish responses
      if (query.includes("کاش") || query.includes("زەرەر") || query.includes("خەسار") || query.includes("پارە")) {
            ...
            return (
              ...
              >
                ...
                <div className="text-xs text-muted-foreground mt-2 flex justify-between items-center w-full">
                  ...
                  <span className={`font-mono font-bold ${company.auditorMetrics.efficiency >= 90 ? "text-success" : company.auditorMetrics.efficiency >= 75 ? "text-warning" : "text-danger"}`}>
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="p-6 rounded-2xl bg-card border border-border space-y-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="p-4 rounded-xl border border-border bg-card/40 text-center">
                <div className="text-xs text-muted-foreground">{locale === "ar" ? "كفاءة المدقق" : "کارایی پشکنەر"}</div>
            ...
            <div className="space-y-3">
              <div className="text-xs font-bold text-muted-foreground">
                {locale === "ar" ? "سجل هفوات ومخالفات المدقق المكتشفة:" : "تۆماری سەرپێچییەکانی پشکنەر:"}
              </div>
              {activeCompanyProfile.auditorMetrics.violationsList.length === 0 ? (
                <div className="text-xs text-success bg-success/5 border border-success/20 p-3 rounded-lg flex items-center gap-2">
                  ...
                  <span>{locale === "ar" ? "المدقق لم يرتكب أي مخالفات مسجلة هذا الشهر. أداء ممتاز وملتزم!" : "پشکنەرەکە هیچ سەرپێچییەکی نییە لەم مانگەدا."}</span>
                </div>
              ) : (
                <div className="space-y-2">
                    ...
                    >
                      ...
                      <div>
                        <div className="font-bold uppercase mb-0.5">
                          {v.type === "critical" ? (locale === "ar" ? "مخالفة حرجة" : "سەرپێچی ڕەخنەیی") : (locale === "ar" ? "تنبيه تحذيري" : "ئاگاداری")}
                        </div>
            ...
            <div className="p-4 rounded-xl border border-primary/20 bg-gradient-to-l from-primary/5 via-card to-card space-y-3">
              <div className="flex items-center justify-between">
                ...
                >
                  ...
                  <span>{checkingLedger ? (locale === "ar" ? "جاري الفحص..." : "پشکنین...") : (locale === "ar" ? "ابدأ الفحص" : "دەستپێکردن")}</span>
                </button>
              </div>
              ...
              {ledgerStatus === "success" && (
                <div className="p-3 rounded-lg bg-success/10 border border-success/30 text-success text-xs flex items-center gap-2">
                  ...
                  <span className="font-medium">{t.auditTamperChecked} ({activeCompanyProfile.auditorMetrics.verifiedLedgerEntriesCount} قيد سليم)</span>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-bold text-foreground px-1 flex items-center gap-2">
              ...
              <span>{locale === "ar" ? "أبرز المشاكل الحالية مترجمة لقرار المالك:" : "کێشە گرنگەکان بۆ بڕیاردانی خاوەنکار:"}</span>
            </h3>

            {activeCompanyProfile.keyIssues.map((issue, idx) => (
              <div key={idx} className="p-5 rounded-2xl bg-card border border-border space-y-4 hover:border-primary/30 transition">
                <div className="flex justify-between items-start gap-3">
                  <div>
                    <h4 className="font-bold text-base text-foreground flex items-center gap-2">
                      <span className={`w-2 h-2 rounded-full ${issue.severity === "danger" ? "bg-danger" : issue.severity === "warning" ? "bg-warning" : "bg-success"}`} />
                      {issue.title[locale]}
                    </h4>
                  ...
                  <div className="text-right shrink-0">
                    <div className="text-xs text-muted-foreground">{locale === "ar" ? "الأثر المالي المهدد" : "کاریگەری دارایی متمانەپێکراو"}</div>
                    <div className="font-mono font-bold text-danger text-lg">{formatIQD(issue.impact)}</div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 border-t border-border pt-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs leading-relaxed text-foreground/80">{issue.translation[locale]}</p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs leading-relaxed text-foreground/80">{issue.risk[locale]}</p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs leading-relaxed font-medium text-success-foreground bg-success/5 p-2 rounded border border-success/15">{issue.action[locale]}</p>
                  </div>
                </div>
              </div>
            ))}
              ...
              {TRANSLATOR_LIBRARY.map((item) => (
                ...
                >
                  <div className="flex justify-between items-center w-full">
                    ...
                    <span className="font-sans font-bold">{locale === "ar" ? item.titleAr : item.titleCkb}</span>
                  </div>
                    ...
                    <>
                      <div>
                        <span className="font-bold text-primary block mb-1">
                          {locale === "ar" ? "شنو يعني هذا الرقم والمصطلح فعلياً؟" : "ئەم زاراوەیە واتای چییە لە ڕاستیدا؟"}
                        </span>
                      ...
                      <div className="pt-2 border-t border-border">
                        <span className="font-bold text-success block mb-1">
                          {locale === "ar" ? "خطوتك العملية كصاحب قرار:" : "هەنگاوی کرداری تۆ چییە؟"}
                        </span>
          ...
          <div className="p-6 rounded-2xl bg-card border border-border flex flex-col h-[520px]">
            ...
            <div className="py-3 border-b border-border shrink-0">
              <span className="text-[11px] text-muted-foreground block mb-2 font-bold">
                {locale === "ar" ? "اضغط على أي سؤال من الأسئلة الشائعة للمالك للحصول على إجابة مبسطة فورية:" : "لەسەر یەکێک لەم پرسیارانە دابگرە بۆ وەڵامی خێرا:"}
              </span>
                ...
                chatLog.map((msg, idx) => (
                  ...
                  >
                    ...
                    <span className="text-[9px] text-muted-foreground mt-1 px-1">
                      {msg.sender === "user" ? (locale === "ar" ? "أنت" : "تۆ") : (locale === "ar" ? "المستشار الذكي" : "ڕاوێژکار")}
                    </span>
                  </div>
                ))
              )}
            ...
            {/* Input Form */}
            <form onSubmit={handleCustomQuery} className="flex gap-2 pt-3 border-t border-border shrink-0">
              <input
                type="text"
                value={customQuery}
