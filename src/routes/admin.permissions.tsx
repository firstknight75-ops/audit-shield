        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
          <div className="w-full max-w-md bg-card border border-border rounded-xl p-6">
            ...
            <p className="text-xs text-muted-foreground mb-4">
              سيتم تسجيل هذا التعديل في السجل غير القابل للتعديل.
            </p>
            ...
            <div className="flex gap-2 mt-6 justify-end">
              ...
              <button
                onClick={confirm}
                disabled={!reason}
                className="px-4 py-2 rounded-md bg-primary text-primary-foreground text-sm font-bold disabled:opacity-50"
              >
                تطبيق
              </button>
            </div>
