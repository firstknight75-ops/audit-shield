...
function RiskMap() {
  return (
    <div>
      <PageHeader
        title="الطبقة الثالثة: نتائج التضارب والشذوذ"
        subtitle="عرض النتائج التي أنتجها محرك التحليل المحلي"
      />
      <div className="space-y-3">
        {ownerLayer3.map((r) => (
          ...
          >
            <div className="p-3 rounded-lg border text-danger border-danger/40 bg-danger/10">
            ...
            <Link
              to="/owner/what-if"
              className="text-xs px-3 py-2 rounded-md bg-primary text-primary-foreground"
            >
              التتبع إلى الأصل
            </Link>
          </div>
