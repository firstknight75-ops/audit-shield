...
const COPY = {
  ...
  ckb: {
    ...
    noAuto: "هیچ بەڵگەنامەیەک بە خۆکار پەسند ناکرێت — هەموو ئەنجامی OCR چاوەڕێ پێداچوونەوە و ڕاستکردنەوەی تۆ دەکات.",
    irreversible: "هەموو پەسندکردنێک لە زنجیرەیەکی نەگۆڕاو تۆمار دەکرێت. کاری تۆ بۆ هەمیشە پارێزراوە.",
